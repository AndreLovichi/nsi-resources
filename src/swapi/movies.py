...
DIST_CSV_FILEPATH = "dist/starwars/movies.csv"
DIST_CSV_HEADERS = ["title", "episodeNumber", "year", "director"]
...
def createMovieCSV():
    ...
    csvUtils.saveAsCsv(DIST_CSV_FILEPATH, DIST_CSV_HEADERS, movieRows)